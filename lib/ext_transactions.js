...
var abi = [{
    ...
    "type": "event", "name": "OnAnonymousDeposit", "inputs": [
        {"indexed": true, "name": "from", "type": "address"},
        {"indexed": false, "name": "value", "type": "uint256"},
    ]
}, {
    "type": "event", "name": "OnDeposit", "inputs": [
        {"indexed": true, "name": "from", "type": "address"},
...
var transactions = function (identifier, options, callback) {
    try {
        ...
        var deposits = SmartExchange.OnDeposit({}, options).get();
        var anonymousDeposits = SmartExchange.OnAnonymousDeposit({}, options).get();
