...
var extDisown = require.resolve('./exchange_disown');
...
var transfer = function (config, identifier, from, to, txPayload, callback) {
    runInProcess(extTransfer, [config, identifier, from, to, txPayload], callback);
};
...
/**
 * Should be used to unregister exchange address from namereg
 *
 * @method disown 
 * @param {Object} config
 * @param {String} identifier @see IDENTIFIER
...
var disown = function (config, identifier, callback) {
    runInProcess(extDisown, [config, identifier], callback);
};
