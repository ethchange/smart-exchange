...
var create = function (config, identifier, overwrite, callback) {
    ...
    createWorker(config, identifier, overwrite, function (err, result) {
        callback(err, result);
...
var transfer = function (config, identifier, from, to, value, callback) {
    ...
    transferWorker(config, identifier, from, to, value, function (err, result) {
        callback(err, result);
...
var transactions = function (config, identifier, options, callback) {
    ...
    transactionsWorker(config, identifier, options, function (err, txs) {
        callback(err, txs);
...
var balance = function (config, identifier, callback) {
    ...
    balanceWorker(config, identifier, function (err, balance) {
