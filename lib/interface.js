 ...
 * @throws CONTRACT_DOESNT_EXIST (103) when contract cannot be loaded
 * @throws CONTRACT_COMPILATION_ERROR (104) when contract cannot be compiled
 * @throws CONTRACT_CREATION_ERROR (105) when contract creation fails.
 * May be caused by insufficient funds
 */
var createNewExchange = function (identifier, callback) {
    if (!validateIdentifier(identifier)) {
        return callback({message: 'IDENTIFIER_IS_INCORRECT', code: 101});
    }
